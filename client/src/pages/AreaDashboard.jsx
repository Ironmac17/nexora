      ...
      <div className="mx-auto max-w-7xl px-6 pt-24 pb-10">
        <div className="mb-10 flex items-start justify-between">
          <div>
            ...
            <p className="text-gray-400 text-lg">Welcome to the virtual campus area</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <motion.div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(26, 31, 46, 0.8) 0%, rgba(37, 42, 65, 0.8) 100%)',
          ...
          >
            ...
            {Object.entries(avatars)
              ...
              .map(([uid, a]) => (
                ...
                >
                  <span className="drop-shadow-lg">{a.name.slice(-2).toUpperCase()}</span>
                  {/* Online Indicator */}
            ...
            {Object.keys(avatars).length <= 1 && (
              ...
              >
                <div className="glass p-6 rounded-2xl text-center max-w-sm mx-4">
                  ...
                  <h3 className="text-lg font-semibold text-purple-300 mb-2">Navigate the Campus</h3>
                  <p className="text-gray-300 text-sm">
                    Click anywhere on the map to move your avatar • Invite friends to join this area
                  </p>
            ...
            <div className="absolute top-4 left-4 glass p-3 rounded-xl">
              <h4 className="text-sm font-semibold text-purple-300 mb-2">Map Legend</h4>
            ...
            <div className="absolute top-4 right-4 glass p-3 rounded-xl">
              <h4 className="text-sm font-semibold text-blue-300">{areaName}</h4>
              <p className="text-xs text-gray-400">{status.usersOnline} active • {status.events} events</p>
            </div>
          </motion.div>
            ...
            <div className="card">
              ...
              {notices.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-500 mt-2">Be the first to post a notice!</p>
                </div>
              ) : (
                <ul className="space-y-4">
                  {notices.map((notice, i) => (
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <h3 className="font-semibold text-green-300">{notice.title}</h3>
                          <p className="mt-1 text-sm text-gray-300">
                            {notice.content}
                          </p>
